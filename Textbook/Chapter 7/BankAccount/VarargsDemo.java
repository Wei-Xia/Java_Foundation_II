/**
  This program demonstrates a method that accepts a variable
  number of arguments (varargs).
*/
...
public class VarargsDemo
{
  ...
  {
    double total;     // To hold the total balance
  ...
  /**
    The totalBalance method takes a variable number of BankAccount
    objects and returns the total of their balances.
