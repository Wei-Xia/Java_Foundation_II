...
/**
  This program gether sales amounts for the week.
  It uses the SalesData class to display the total, average, highest, and
  lowest sales amounts.
*/
...
public class Sales
{
  public static void main(String[] args)
  {
      ...
      // Display the total, average, highest, lowest sales amounts for the week.
