...
public class CurvedActivity extends GradedActivity
{
  ...
  double percentage;      // Curved percentage
  ...
  */
  ...
  /**
    ...
    This version accepts the unadjusted score as an argument. That score is
    multiplied by the curve percentage and the result is sent as an argument
