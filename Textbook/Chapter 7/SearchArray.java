...
public class SearchArray
{
  public static void main(String[] args)
  {
      ...
      if (results == -1)
        System.out.println("You did not find 100 on any test.");
      else
        System.out.println("You found 100 on any test.");
  }
  ...
  /**
    ...
    @return The subscript of the value if found in the array,
          otherwise -1
  */
