    ...
    public static void main(String[] args)
      {
        ...
        while (!input.equals(SENTINEL))         // SENTINEL string terminates loop, which processes each input string in turn
          {
            StringTokenizer words = new StringTokenizer(input);          // break up input into sequence of its constituent words
            String[] wordCollection = new String[words.countTokens()];   // stores words as they are encountered
            ...
            while (words.hasMoreTokens())            // keep going while there are still words left in the line to process
              {
