/**
  ...
  and unformatting U.S. telephone numbers.
*/

public class Telephone
{
      // These constant fields hold the valid lengths of strings that
      // are formatted and unformatted.

      public final static int FORMATTED_LENGTH = 13;
      public final static int UNFORMATTED_LENGTH = 10;

      /**
        This isFormatted method determines whether a string is properly formatted
        as a U.S. telephone number in the following manner: (XXX)XXX-XXXX
      ...
      */
      ...
      /**
        ...
        (XXX)XXX-XXXX.
        If the argument is formatted in this way, the method returns an unformatted
        string where the parentheses and hyphen have been removed. Otherwise, it
      ...
      */
      ...
      public static String unformat(String str)
      {
        ...
        if (isFormatted(str))
        {
            ...
            // Next, delete the hyphen. Because of the previous deletion it is
            // now located at position 6.
            strb.deleteCharAt(6);
        }
      ...
      /**
        ...
        the formatted string. Otherwise, it returns the original argument.
